...
```bash
# if root
wget -qO - https://raw.githubusercontent.com/garcia567/pve-patch/master/patch.sh | bash

# if non-root
wget -qO - https://raw.githubusercontent.com/garcia567/pve-patch/master/patch.sh | sudo bash
```
